...
Elm.Snake.AI.Interface.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.AI = _elm.Snake.AI || {};
   _elm.Snake.AI.Interface = _elm.Snake.AI.Interface || {};
   if (_elm.Snake.AI.Interface.values) return _elm.Snake.AI.Interface.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.Cell = Elm.Snake.Model.Cell || {};
Elm.Snake.Model.Cell.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.Cell = _elm.Snake.Model.Cell || {};
   if (_elm.Snake.Model.Cell.values) return _elm.Snake.Model.Cell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   return _elm.Snake.Model.Cell.values = {_op: _op};
};
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.Size = Elm.Snake.Model.Size || {};
Elm.Snake.Model.Size.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.Size = _elm.Snake.Model.Size || {};
   if (_elm.Snake.Model.Size.values) return _elm.Snake.Model.Size.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.Snake.Utility.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var set = F4(function (i,j,x,array) {
      var _p0 = A2($Array.get,i,array);
      if (_p0.ctor === "Nothing") {
            return array;
         } else {
            var subArray$ = A3($Array.set,j,x,_p0._0);
   ...
   var nthAndRest = F2(function (n,xs) {
      var after = A2($List.drop,n,xs);
      var x = head(after);
      var after$ = tail(after);
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.Snake = Elm.Snake.Model.Snake || {};
Elm.Snake.Model.Snake.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.Snake = _elm.Snake.Model.Snake || {};
   if (_elm.Snake.Model.Snake.values) return _elm.Snake.Model.Snake.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var initialBody = F3(function (len,_p0,acc) {
      initialBody: while (true) {
         ...
         if (_U.eq(len,0)) return acc; else {
               var newCell = {ctor: "_Tuple2",_0: _p2,_1: _p3};
   ...
   var nextBodyCell = function (snake) {
      ...
      var hx = _p4._0;
      var hy = _p4._1;
      var _p5 = snake.direction;
      switch (_p5.ctor)
      {case "Up": return {ctor: "_Tuple2",_0: hx,_1: hy + 1};
         case "Down": return {ctor: "_Tuple2",_0: hx,_1: hy - 1};
         case "Left": return {ctor: "_Tuple2",_0: hx - 1,_1: hy};
         default: return {ctor: "_Tuple2",_0: hx + 1,_1: hy};}
   };
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.Food = Elm.Snake.Model.Food || {};
Elm.Snake.Model.Food.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.Food = _elm.Snake.Model.Food || {};
   if (_elm.Snake.Model.Food.values) return _elm.Snake.Model.Food.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Snake$Model$Cell = Elm.Snake.Model.Cell.make(_elm);
   var _op = {};
   var randGen = F2(function (w,h) {
      return A3($Random.map2,F2(function (x,y) {    return {ctor: "_Tuple2",_0: x,_1: y};}),A2($Random.$int,0,w - 1),A2($Random.$int,0,h - 1));
   });
...
Elm.Snake.Control.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Control = _elm.Snake.Control || {};
   if (_elm.Snake.Control.values) return _elm.Snake.Control.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Char = Elm.Char.make(_elm),
   $Debug = Elm.Debug.make(_elm),
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.World = Elm.Snake.Model.World || {};
Elm.Snake.Model.World.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.World = _elm.Snake.Model.World || {};
   if (_elm.Snake.Model.World.values) return _elm.Snake.Model.World.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Snake$Config = Elm.Snake.Config.make(_elm),
   $Snake$Model$Cell = Elm.Snake.Model.Cell.make(_elm),
   $Snake$Model$Food = Elm.Snake.Model.Food.make(_elm),
   $Snake$Model$Size = Elm.Snake.Model.Size.make(_elm),
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Model = Elm.Snake.Model || {};
Elm.Snake.Model.WorldAux = Elm.Snake.Model.WorldAux || {};
Elm.Snake.Model.WorldAux.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Model = _elm.Snake.Model || {};
   _elm.Snake.Model.WorldAux = _elm.Snake.Model.WorldAux || {};
   if (_elm.Snake.Model.WorldAux.values) return _elm.Snake.Model.WorldAux.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var cellOutOfBound = F2(function (_p1,world) {
      var _p2 = _p1;
      var _p4 = _p2._1;
      var _p3 = _p2._0;
   ...
   var handleCommand = F2(function (input,world) {
      var _p5 = input;
      if (_p5.ctor === "Command") {
            return world.commandHandled ? world : _U.update(world,{snake: A2($Snake$Model$Snake.turn,_p5._0,world.snake),commandHandled: true});
         } else {
            return world;
         }
   });
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.AI = Elm.Snake.AI || {};
Elm.Snake.AI.Main = Elm.Snake.AI.Main || {};
Elm.Snake.AI.Main.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.AI = _elm.Snake.AI || {};
   _elm.Snake.AI.Main = _elm.Snake.AI.Main || {};
   if (_elm.Snake.AI.Main.values) return _elm.Snake.AI.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Snake$Utility = Elm.Snake.Utility.make(_elm);
   var _op = {};
   var fill = F4(function (world,maxSteps,queue,visited) {
      fill: while (true) {
         var _p0 = queue;
         if (_p0.ctor === "[]") {
               return visited;
               ...
               var _p2 = _p0._0;
               if (_U.cmp($Set.size(visited),maxSteps) > -1) return visited; else {
                     var _p1 = _p2;
                     var x = _p1._0;
                     var y = _p1._1;
                     ...
                     var q3 = A2(checkAndAdd,{ctor: "_Tuple2",_0: x,_1: y + 1},q2);
                     var q4 = A2(checkAndAdd,{ctor: "_Tuple2",_0: x,_1: y - 1},q3);
                     var visited$ = A2($Set.insert,_p2,visited);
                     var _v1 = world,_v2 = maxSteps,_v3 = q4,_v4 = visited$;
                     world = _v1;
                     maxSteps = _v2;
                     queue = _v3;
                     visited = _v4;
   ...
   var next = function (world) {
      ...
      if (_p22.ctor === "Nothing") {
            return $Basics.not(A2(willDie,world,$Snake$Control.Null)) ? {ctor: "_Tuple2",_0: $Snake$Control.Null,_1: stateReset} : nextRandom(world);
         } else {
            if (_p22._0.ctor === "Command") {
                  return {ctor: "_Tuple2",_0: $Snake$Control.Command(_p22._0._0),_1: _U.update(stateReset,{lastTurn: cur})};
               } else {
                  return {ctor: "_Tuple2",_0: _p22._0,_1: stateReset};
               }
         }
   };
...
Elm.Snake.Game.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Game = _elm.Snake.Game || {};
   if (_elm.Snake.Game.values) return _elm.Snake.Game.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Snake$AI$Main = Elm.Snake.AI.Main.make(_elm),
   $Snake$Config = Elm.Snake.Config.make(_elm),
   $Snake$Control = Elm.Snake.Control.make(_elm),
   $Snake$Model$World = Elm.Snake.Model.World.make(_elm),
   $Snake$Model$WorldAux = Elm.Snake.Model.WorldAux.make(_elm);
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Visual = Elm.Snake.Visual || {};
Elm.Snake.Visual.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Visual = _elm.Snake.Visual || {};
   if (_elm.Snake.Visual.values) return _elm.Snake.Visual.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   ...
   return _elm.Snake.Visual.values = {_op: _op
                                     ...
                                     ,Food: Food
                                     ,Snake: Snake
                                     ,worldToMarkGrid: worldToMarkGrid
                                     ,markFood: markFood
                                     ,markSnake: markSnake
...
Elm.Snake = Elm.Snake || {};
Elm.Snake.Main = Elm.Snake.Main || {};
Elm.Snake.Main.make = function (_elm) {
   "use strict";
   _elm.Snake = _elm.Snake || {};
   _elm.Snake.Main = _elm.Snake.Main || {};
   if (_elm.Snake.Main.values) return _elm.Snake.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
